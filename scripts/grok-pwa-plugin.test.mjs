...
/**
 * An empty workspace root. Injector defaults (`site`, card detection) read
 * from `cwd`, which falls back to `process.cwd()` — this repo's own
 * `src/lib/og/site.json` and `public/og.jpg`. Tests below pin function
 * behavior, not this workspace's share-card customization, so they run
 * against an empty root instead.
 */
